<template>
  <div id="collection" ref="list">
    <div class="card" v-for="(item, index) in answerList" :key="index">
      <a class="user">
        <el-image
